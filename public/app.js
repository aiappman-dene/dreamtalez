...
import { getCurrentLanguage, setCurrentLanguage, t, applyUILanguage, LS_LANG_KEY, SUPPORTED_LANGUAGES, LANGUAGE_LABELS, RTL_LANGUAGES } from './modules/i18n.js?v=20260521b';
import { pick, formatName } from './modules/utils.js';
import { isInputSafe } from './modules/safety.js?v=20260521a';
...
import { updateStreakDisplay, recordStreakForChild, showMilestoneCelebration, todayKey, dayDiff, configure as configureStreaks } from './modules/streaks.js?v=20260521b';
import { renderLibrary, saveStoryToLibrary, saveCurrentStoryToLibrary, deleteFromLibrary, reReadFromLibrary, formatSavedDate, configure as configureLibrary } from './modules/library.js?v=20260521c';
